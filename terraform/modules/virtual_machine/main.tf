...
resource "azurerm_linux_virtual_machine" "vm-linux" {
  ...
  # Use source_image_id instead of source_image_reference for custom images
  # source_image_id = var.custom_image_id  # This should be the full resource ID of your image in ACR
