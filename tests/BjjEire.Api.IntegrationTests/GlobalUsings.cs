...
global using BjjEire.Application.Features.Competitions.DTOs;
global using BjjEire.Application.Features.Gyms.DTOs;
global using BjjEire.Application.Features.Stores.DTOs;
global using BjjEire.Core.Common;
global using BjjEire.Core.Data;
global using BjjEire.Core.Extensions;
global using BjjEire.Core.Fixtures;
global using BjjEire.Core.Interfaces;
