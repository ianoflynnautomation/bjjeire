...
|---|---|---|---|
| OpenAPI provider contract | `src/bjjeire-api/src/test/java/com/bjjeire/api/web/OpenApiContractIT.java` | API CI | API stops publishing expected paths, schemas, fields, response envelopes, or ProblemDetails contracts |
...
1. API PRs run the Java OpenAPI contract tests.
