...
public static class PostgresConfiguration
{
        ...
        IDistributedApplicationBuilder builder)
    {
        ...
        var postgres = builder.AddDockerfile("postgres-1", "../../../infra/postgres")
        ...
        //var postgres = builder.AddContainer("postgres-1", "postgres")
            ...
            .WithEnvironment("GRAFANA_DB_PASSWORD", builder.Configuration["GF_DATABASE_USER"] ?? "local-dev-password");
