...
public static class FrontendConfiguration {
    public static IResourceBuilder<NodeAppResource> AddFrontend(
        ...
        var frontend = builder.AddNpmApp("react", "../bjjworld-app")
            ...
            .WithHttpEndpoint(port: ServiceConstants.FrontendHttpPort, targetPort: 80, name: "http")
            .WithHttpEndpoint(port: ServiceConstants.FrontendHttpsPort, targetPort: 443, name: "https")
