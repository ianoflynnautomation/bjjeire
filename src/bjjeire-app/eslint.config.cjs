...
module.exports = tseslint.config(
  ...
  },
  {
    ...
    rules: {
      // TypeScript rules
      // void-returning arrow shorthand (onClick={() => setX(1)}) is idiomatic React
      '@typescript-eslint/no-confusing-void-expression': [
        'error',
        { ignoreArrowShorthand: true },
      ],
      // numbers in template literals are safe and ubiquitous (counts, pages, ids)
      '@typescript-eslint/restrict-template-expressions': [
        'error',
        { allowNumber: true },
      ],
      // empty arrows are the standard no-op default for callbacks/mocks
