...
export const GymCard: React.FC<GymCardProps> = memo(({ gym, 'data-testid': dataTestId }) => {
  ...
  return (
    ...
    >
      {/* Gym Header Section */}
      <GymHeader name={name} county={county} status={status} imageUrl={imageUrl} />

      <div className="flex flex-1 flex-col p-4 sm:p-5"> {/* Content padding */}
        {/* Gym Details Section */}
