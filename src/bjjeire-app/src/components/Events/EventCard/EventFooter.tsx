// src/features/events/components/EventCard/EventFooter.tsx
...
export const EventFooter: React.FC<EventFooterProps> = memo(({ eventUrl, eventName }) => {
  ...
  return (
    <div className="mt-auto border-t border-slate-200 dark:border-slate-700 pt-3"> {/* UPDATED: Matched GymFooter styling */}
      <a
      ...
      >
        <LinkIcon className="-ml-0.5 h-5 w-5" aria-hidden="true" /> {/* Icon color will inherit text-white */}
        More Information
      </a>
    </div>
  );
