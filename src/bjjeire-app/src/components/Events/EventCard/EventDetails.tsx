...
export const EventDetails: React.FC<EventDetailsProps> = memo(
  ({
    ...
    testIdInstanceSuffix = event.id || event.name.replace(/\s+/g, '-').toLowerCase(),
  }) => {
    const { name, location, socialMedia, pricing, schedule, organiser } = event;

    const rootTestId = sectionDataTestId || withTestIdSuffix(EventCardTestIds.DETAILS.ROOT, testIdInstanceSuffix);
      ...
      >
        ...
        {location && (
          <DetailItem
            ...
            data-testid={withTestIdSuffix(EventCardTestIds.DETAILS.ADDRESS, testIdInstanceSuffix)}
        ...
        {organiser && organiserDisplay && (
          <DetailItem
            ...
            data-testid={withTestIdSuffix(EventCardTestIds.DETAILS.ORGANISER, testIdInstanceSuffix)}
            testIdInstanceSuffix={testIdInstanceSuffix}
          >
            <a
        ...
        {pricingDisplay && (
          <DetailItem
            ...
            data-testid={withTestIdSuffix(EventCardTestIds.DETAILS.PRICING, testIdInstanceSuffix)}
            testIdInstanceSuffix={testIdInstanceSuffix}
          >
            {pricingDisplay}
          </DetailItem>
        ...
        {socialMedia && ( 
          <div className="pt-1">
            <SocialMediaLinks 
              ...
              data-testid={withTestIdSuffix(EventCardTestIds.DETAILS.SOCIAL_MEDIA, testIdInstanceSuffix)}
              testIdInstanceSuffix={testIdInstanceSuffix}
            />
          </div>
        )}
