              ...
              {navItems.map(item => (
                <li key={item.id}>
                  <Link
                    to={item.to}
                    viewTransition
                    className="font-medium text-primary-600 underline-offset-2 transition-colors hover:text-primary-700 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/70 dark:text-primary-400 dark:hover:text-primary-300"
