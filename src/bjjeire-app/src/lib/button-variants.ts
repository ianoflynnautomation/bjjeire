...
export const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-xl font-medium transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/70 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        gradient:
          'border border-emerald-500/50 bg-linear-to-r from-emerald-600 via-emerald-500 to-green-500 text-white shadow-sm hover:-translate-y-0.5 hover:from-emerald-700 hover:to-green-600 hover:shadow-md',
        solid:
          'border border-emerald-500 bg-emerald-700 text-white hover:bg-emerald-800',
        outline:
