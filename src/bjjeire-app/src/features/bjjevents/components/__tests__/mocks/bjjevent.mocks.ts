...
export const location: LocationDto = {
...
const fullSchedule: BjjEventScheduleDto = {
  ...
  sessions: [
    { date: '2026-04-01T00:00:00Z', startTime: '10:00', endTime: '12:00' },
  ],
}
...
export const MOCK_EVENT_MINIMAL: BjjEventDto = createEvent({
  ...
  location,
  socialMedia: {},
  schedule: { kind: ScheduleKind.FixedDates, sessions: [] },
  pricingOptions: [{ type: PricingType.FlatRate, amount: 40, currency: 'EUR' }],
  eventUrl: '',
  imageUrl: '',
})
