  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="relative mt-1">
        ...
        <select
          id={id}
          value={value as string} // Cast to string for HTML select compatibility
          onChange={handleChange}
          disabled={disabled}
          className="block w-full rounded-md border-gray-300 pl-10 pr-4 py-2 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
        >
