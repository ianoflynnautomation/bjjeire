...
export const FixedDateScheduleView: React.FC<FixedDateScheduleViewProps> = ({ schedule }) => {
  return (
    <ScheduleSection title="Event Dates & Times" icon={<CalendarDaysIcon className="text-orange-500" />}>
      ...
      {schedule.hours && schedule.hours.length > 0 ? (
        ...
        <div className="mt-1.5 flex items-center gap-x-2 text-xs text-slate-600 pl-7">
          <ClockIcon className="h-4 w-4 flex-shrink-0  text-orange-500" aria-hidden="true" />
